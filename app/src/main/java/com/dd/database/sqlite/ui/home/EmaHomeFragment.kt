...
import com.dd.database.sqlite.dialog.loading.LoadingDialogData
import com.dd.database.sqlite.dialog.simple.SimpleDialogData
import com.dd.database.sqlite.dialog.simple.SimpleDialogListener
...
class EmaHomeFragment : BaseFragment<EmaHomeState, EmaHomeViewModel, EmaHomeNavigator.Navigation>() {
    ...
    override val layoutId: Int = com.dd.database.sqlite.R.layout.fragment_home
